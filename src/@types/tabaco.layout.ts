...
export const getThemeColor = (color: Color = Color.PRIMARY): string => color;

export const getTextColor = (color: Color = Color.PRIMARY): string =>
  [Color.WARNING, Color.LIGHT].indexOf(getThemeColor(color) as Color) < 0 ? Color.LIGHT : Color.DARK;
